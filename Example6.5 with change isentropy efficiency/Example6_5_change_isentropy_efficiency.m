...
T_1=288;P_1=101.35;n_c=0.88;n_GT=0.91;n_PT=0.88;m_cdot=1;PRF=1.35;n_fc=0.87;n_fn=1;alpha=10; %variable
...
for T_3=1900%1400:200:2000
    ...
    labels=('n_c=0.88 n_G_T=0.91 n_f_c=0.87');
    legend(labels,'Location','northeast','Fontsize',18);
    set(gca,'Fontname','Times New Roman','FontWeight','bold');
    hold on;
    subplot(2,2,2);
    plot(PR,thrust,'b','LineWidth',1.5);
    xlabel('PR','Fontsize',18);
...
sgtitle('real combustion with change isentropy efficiency','Fontsize',24);