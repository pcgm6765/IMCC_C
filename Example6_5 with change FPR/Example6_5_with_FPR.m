...
T_1=288;P_1=101.35;n_c=0.88;n_GT=0.91;n_PT=0.90;m_cdot=1;n_fc=0.87;n_fn=1;;alpha=10;T_3=1900; %variable
for PRF=1.35:0.15:1.8
    i=0;
    ...
    labels={'FPR=1.35','FPR=1.50','FPR=1.65','FPR=1.80'};
...
sgtitle('real combustion with change FPR','Fontsize',24);