...
T_1=288;P_1=101.35;P_5=101.35;n_c=0.88;n_GT=0.91;n_PT=0.89;m_dot=1;n_fc=0.87;alpha=10;fpr=1.35;n_N=1  %variable
for T_3=1900%:200:2000
    PR=10:1:70;
    PR(18)=[];
    for i=1:1:60
          Pr_1=interp1(T,Pr,T_1,'spline');h_1=interp1(T,h,T_1,'spline');
          Pr_2d(i)=Pr_1*fpr;P_3(i)=PR(i)*P_1;
          ...
          Pr_2(i)=Pr_1*PR(i);h_2s(i)=interp1(Pr,h,Pr_2(i),'spline');
          ...
          thrust_frome_core(i)=(1+f(i))*V5s(i)/t(i)*100;
    end
    PR=10:1:70;
    PR(18)=[];
    figure('color','white');
    subplot(2,2,1);
    plot(PR,TSFC,'b','LineWidth',1.5);
    xlabel('PR','Fontsize',18);
    ylabel('TSFC(mg/N*s)','Fontsize',18);
    newcolors={'r','g','b','k'};
    colororder(newcolors);
    labels={'Air Equivalent'};
    legend(labels,'Location','northeast','Fontsize',18);
    set(gca,'Fontname','Times New Roman','FontWeight','bold');
    hold on;
    subplot(2,2,2);
    plot(PR,t,'b','LineWidth',1.5);
    xlabel('PR','Fontsize',18);
    ...
    hold on;
    subplot(2,2,[3,4]);
    plot(PR,thrust_frome_core,'b','LineWidth',1.5);
    xlabel('PR','Fontsize',18);
...
sgtitle('Real Combustion vs. Air Equivalent','Fontsize',24);