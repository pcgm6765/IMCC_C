...
for T_3=1600:200:2000
    ...
    hold on;
    subplot(2,2,[3,4]);
    plot(PR,thrust_frome_core,'LineWidth',1.5);
    xlabel('PR','Fontsize',18);
...
sgtitle('real combustion with change turbine unlet temperature','Fontsize',24);