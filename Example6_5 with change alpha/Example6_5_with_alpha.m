...
T_1=288;P_1=101.35;n_c=0.88;n_GT=0.91;n_PT=0.90;m_cdot=1;PRF=1.35;n_fc=0.87;n_fn=1;T_3=1900 %variable
...
for alpha=5:5:20
    ...
    labels={'alpha=5','alpha=10','alpha=15','alpha=20'};
...
sgtitle('real combustion with change alpha','Fontsize',24);